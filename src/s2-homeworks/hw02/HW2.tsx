...
export const filterAffairs = (affairs: Array<AffairType>, filter: FilterType): Array<AffairType> => { // need to fix any
    ...
    return affairs= filter === 'low' ? affairs.filter(affair => affair.priority === 'low') : filter === 'middle' ? affairs.filter(affair => affair.priority === 'middle') :
        filter === 'high' ? affairs.filter(affair => affair.priority === 'high') : affairs // need to fix
}
